...
def main():
    ...
    results.append(test_endpoint("Root Endpoint", "GET", f"{BASE_URL}/"))

    # Test 2: Health check
    results.append(test_endpoint("Health Check", "GET", f"{BASE_URL}/api/health"))

    # Test 3: Get sources
    results.append(test_endpoint("Get Sources", "GET", f"{BASE_URL}/api/sources"))

    # Test 4: Get statistics
    results.append(test_endpoint("Get Statistics", "GET", f"{BASE_URL}/api/stats"))
    ...
    results.append(test_endpoint("Get Article by ID (id=1)", "GET", f"{BASE_URL}/api/articles/1"))
    ...
    results.append(test_endpoint("Scraping Status", "GET", f"{BASE_URL}/api/scraping/status"))
